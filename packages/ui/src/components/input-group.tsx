...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: this is a generic input wrapper, not a form fieldset.
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents lint/a11y/useSemanticElements: clicks focus the nested input; keyboard users can tab to the input directly.
		<div
			role="group"
